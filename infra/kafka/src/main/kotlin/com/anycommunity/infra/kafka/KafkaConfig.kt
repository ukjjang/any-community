package com.anycommunity.infra.kafka
...
class KafkaConfig(
    ...
    @Bean
    fun kafkaStringTemplate(): KafkaTemplate<String, String> = KafkaTemplate(kafkaStringProducerFactory())

    @Bean
    fun kafkaStringConsumerConfig(): Map<String, Any> = mapOf(
    ...
    fun kafkaStringConsumerFactory(): DefaultKafkaConsumerFactory<String, String> =
        DefaultKafkaConsumerFactory(kafkaStringConsumerConfig())
    ...
    private fun deadLetterRecoverer(): DeadLetterPublishingRecoverer =
        DeadLetterPublishingRecoverer(kafkaStringTemplate()) { record, exception ->
